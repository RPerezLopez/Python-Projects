...
class Enemy(Ship):
	...
	def shoot(self):
		if self.cool_down_counter == 0:
			laser = Laser(self.x - 21, self.y, self.lasers_img)
			self.lasers.append(laser)
			self.cool_down_counter = 1


#This will check if the player and any enemy ships have collided.
...
def main_menu():
	...
	while run:
		WIN.blit(BG, (0,0))
		title_label = title_font.render("Press your mouse to begin...", 1, (255, 255, 255))
